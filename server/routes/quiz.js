...
router.post("/create", auth, (req, res) => {
  ...
  const room = {
    id: uuidv4(), code, title: title || "Study Quiz",
    hostId: req.user.id, hostName: req.user.name,
    questions, isPublic: !!isPublic, timePerQuestion: timePerQuestion || 20,
    status: "waiting", players: [], currentQuestion: -1, scores: {}, chat: [],
