...
function PrivateRoute({ children }) {
  ...
  if (loading) return (
    <div style={{ display:"flex",alignItems:"center",justifyContent:"center",minHeight:"100vh",flexDirection:"column",gap:16,background:"var(--bg-primary)" }}>
      <div style={{ width:44,height:44,border:"3px solid rgba(108,99,255,0.2)",borderTopColor:"var(--accent)",borderRadius:"50%",animation:"spin 0.8s linear infinite" }}/>
    ...
    <AuthProvider>
      <BrowserRouter>
        ...
        <Routes>
          ...
          {/* oauth/callback MUST be outside both guards */}
